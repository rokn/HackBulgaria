...
namespace XNARpg
{
	public static class Input
	{
		...
		public static void Update(GameTime gameTime)
		{
			...
			ClickRectangle.UpdateViaVector(_position);
		...
		{
			if (_currentmouse.LeftButton != ButtonState.Pressed || _oldmouse.LeftButton != ButtonState.Released) return false;
		...
		public static bool LeftHeld()
		{
			...
			if ((_currentmouse.LeftButton != ButtonState.Pressed || _oldmouse.LeftButton != ButtonState.Pressed)) return false;
		...
		public static bool RightHeld()
		{
			...
			if ((_currentmouse.RightButton != ButtonState.Pressed || _oldmouse.RightButton != ButtonState.Pressed)) return false;
